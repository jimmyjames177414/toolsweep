...
Schema validity is not schema usability. Nothing tells you **which of your schema decisions** — the
name, the enum wording, the nesting depth, the fact that you exposed 40 tools instead of 12 — is the
one costing you accuracy.
...
- Published findings on tool-selection degradation as tool count grows, tool overlap, and retrieval —
  all of which constrain what we may claim as new.
...
It is also the right shape for this portfolio: it is the same intellectual spine as Stopless and
